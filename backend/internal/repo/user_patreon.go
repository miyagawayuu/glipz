...
// SetUserPatreonCampaignID stores the campaign ID fetched after OAuth completes.
...
// SetUserPatreonRequiredRewardTierID stores the reward tier ID required to unlock paid note content.
...
// ClearUserPatreonCreator disconnects the creator-side Patreon integration and clears campaign settings.
