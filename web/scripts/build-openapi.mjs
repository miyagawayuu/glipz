...
const routes = [
  ...
  { path: "/auth/register/resend", method: "post", summary: "Resend registration verification", tag: "Auth", security: "none" },
  ...
  { path: "/auth/logout", method: "post", summary: "Logout", tag: "Auth", security: "none" },
  ...
  { path: "/instance-settings", method: "get", summary: "Public instance settings", tag: "Public", security: "none" },
  ...
  { path: "/public/federation/incoming/stream", method: "get", summary: "Public federated feed SSE", tag: "Public federation", security: "none" },
  { path: "/public/federation/custom-emoji", method: "get", summary: "Resolve public federated custom emoji", tag: "Public federation", security: "none" },
  { path: "/public/federation/incoming", method: "get", summary: "Public federated incoming posts by actor", tag: "Public federation", security: "optional" },
  ...
  { path: "/media/remote", method: "get", summary: "Proxy remote media", tag: "Media", security: "none" },
  { path: "/media/remote", method: "head", summary: "Remote media metadata", tag: "Media", security: "none" },
  { path: "/identity/transfers/{sessionID}/manifest", method: "get", summary: "Identity transfer manifest", tag: "Identity portability", security: "none" },
  { path: "/identity/transfers/{sessionID}/profile", method: "get", summary: "Identity transfer profile export", tag: "Identity portability", security: "none" },
  { path: "/identity/transfers/{sessionID}/posts", method: "get", summary: "Identity transfer posts export", tag: "Identity portability", security: "none" },
  { path: "/identity/transfers/{sessionID}/following", method: "get", summary: "Identity transfer following export", tag: "Identity portability", security: "none" },
  { path: "/identity/transfers/{sessionID}/followers", method: "get", summary: "Identity transfer followers export", tag: "Identity portability", security: "none" },
  { path: "/identity/transfers/{sessionID}/bookmarks", method: "get", summary: "Identity transfer bookmarks export", tag: "Identity portability", security: "none" },
  { path: "/identity/transfers/{sessionID}/media", method: "get", summary: "Identity transfer media export", tag: "Identity portability", security: "none" },
  { path: "/fanclub/patreon/callback", method: "get", summary: "Patreon OAuth callback", tag: "Fan club", security: "none" },
  ...
  { path: "/communities", method: "get", summary: "List communities", tag: "Communities", security: "optional" },
  { path: "/communities/{communityID}", method: "get", summary: "Get community", tag: "Communities", security: "optional" },
  { path: "/communities/{communityID}/posts", method: "get", summary: "Community posts", tag: "Communities", security: "optional" },
  { path: "/communities/{communityID}/post-media-tiles", method: "get", summary: "Community media tiles", tag: "Communities", security: "optional" },
  ...
  { path: "/admin/overview", method: "get", summary: "Admin overview", tag: "Admin", security: "admin" },
  { path: "/admin/users", method: "get", summary: "List users", tag: "Admin", security: "admin" },
  { path: "/admin/users/{userID}", method: "get", summary: "Get user", tag: "Admin", security: "admin" },
  { path: "/admin/users/{userID}/suspension", method: "patch", summary: "Update user suspension", tag: "Admin", security: "admin" },
  { path: "/admin/instance-settings", method: "get", summary: "Get instance settings", tag: "Admin", security: "admin" },
  { path: "/admin/instance-settings", method: "patch", summary: "Update instance settings", tag: "Admin", security: "admin" },
  ...
  { path: "/admin/federation/known-instances", method: "get", summary: "List known federation instances", tag: "Admin", security: "admin" },
  { path: "/admin/federation/known-instances", method: "post", summary: "Add known federation instance", tag: "Admin", security: "admin" },
  { path: "/admin/federation/known-instances", method: "delete", summary: "Remove known federation instance", tag: "Admin", security: "admin" },
  ...
  { path: "/admin/reports/dm", method: "get", summary: "List direct message reports", tag: "Admin", security: "admin" },
  ...
  { path: "/admin/reports/dm/{reportID}", method: "patch", summary: "Update direct message report status", tag: "Admin", security: "admin" },
  { path: "/admin/legal-requests", method: "get", summary: "List law enforcement requests", tag: "Admin", security: "admin" },
  { path: "/admin/legal-requests", method: "post", summary: "Create law enforcement request", tag: "Admin", security: "admin" },
  { path: "/admin/legal-requests/{requestID}", method: "patch", summary: "Update law enforcement request", tag: "Admin", security: "admin" },
  { path: "/admin/legal-requests/{requestID}/holds", method: "post", summary: "Create legal preservation hold", tag: "Admin", security: "admin" },
  { path: "/admin/legal-requests/{requestID}/export", method: "get", summary: "Export law enforcement disclosure package", tag: "Admin", security: "admin" },
  ...
  { path: "/me/account", method: "delete", summary: "Delete current account", tag: "Account", security: "bearer" },
  { path: "/me/identity/export", method: "get", summary: "Export identity", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/export-secure", method: "post", summary: "Create encrypted identity export", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/import", method: "put", summary: "Import identity", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/import-secure", method: "put", summary: "Import encrypted identity bundle", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/move", method: "post", summary: "Declare identity move", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/transfer-sessions", method: "post", summary: "Create identity transfer session", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/transfer-sessions/{sessionID}", method: "get", summary: "Get identity transfer session", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/transfer-sessions/{sessionID}", method: "delete", summary: "Revoke identity transfer session", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/import-jobs", method: "post", summary: "Start identity import job", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/import-jobs/{jobID}", method: "get", summary: "Get identity import job", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/import-jobs/{jobID}/retry", method: "post", summary: "Retry identity import job", tag: "Identity portability", security: "bearer" },
  { path: "/me/identity/import-jobs/{jobID}", method: "delete", summary: "Cancel identity import job", tag: "Identity portability", security: "bearer" },
  ...
  { path: "/dm/threads/{threadID}/messages/{messageID}/report", method: "post", summary: "Report direct message", tag: "Direct messages", security: "bearer" },
  ...
  { path: "/me/timeline-settings", method: "get", summary: "Get timeline settings", tag: "Account", security: "bearer" },
  { path: "/me/timeline-settings", method: "put", summary: "Save timeline settings", tag: "Account", security: "bearer" },
  { path: "/me/timeline-settings", method: "delete", summary: "Reset timeline settings", tag: "Account", security: "bearer" },
  ...
  { path: "/posts/feed/custom", method: "post", summary: "Authenticated custom feed", tag: "Posts", security: "bearer" },
  { path: "/posts/bookmarks", method: "get", summary: "Bookmarks", tag: "Posts", security: "bearer" },
  { path: "/communities", method: "post", summary: "Create community", tag: "Communities", security: "bearer" },
  { path: "/communities/{communityID}", method: "patch", summary: "Update community", tag: "Communities", security: "bearer" },
  { path: "/communities/{communityID}", method: "delete", summary: "Delete community", tag: "Communities", security: "bearer" },
  { path: "/communities/{communityID}/join-requests", method: "post", summary: "Request community join", tag: "Communities", security: "bearer" },
  { path: "/communities/{communityID}/join-requests", method: "get", summary: "List community join requests", tag: "Communities", security: "bearer" },
  { path: "/communities/{communityID}/members/{userID}/approve", method: "post", summary: "Approve community join request", tag: "Communities", security: "bearer" },
  { path: "/communities/{communityID}/members/{userID}/reject", method: "post", summary: "Reject community join request", tag: "Communities", security: "bearer" },
  ...
  { path: "/me/federation/blocks", method: "get", summary: "List federated actor blocks", tag: "Federation", security: "bearer" },
  { path: "/me/federation/blocks", method: "post", summary: "Add federated actor block", tag: "Federation", security: "bearer" },
  { path: "/me/federation/blocks", method: "delete", summary: "Remove federated actor block", tag: "Federation", security: "bearer" },
  { path: "/me/federation/mutes", method: "get", summary: "List federated actor mutes", tag: "Federation", security: "bearer" },
  { path: "/me/federation/mutes", method: "post", summary: "Add federated actor mute", tag: "Federation", security: "bearer" },
  { path: "/me/federation/mutes", method: "delete", summary: "Remove federated actor mute", tag: "Federation", security: "bearer" },
  { path: "/me/federation/relationship", method: "get", summary: "Get federated actor relationship", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/invite", method: "post", summary: "Send federated DM invite", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/accept", method: "post", summary: "Accept federated DM invite", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/reject", method: "post", summary: "Reject federated DM invite", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/message", method: "post", summary: "Send federated DM message", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/threads", method: "get", summary: "List federated DM threads", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/threads/{threadID}/messages", method: "get", summary: "List federated DM messages", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/keys", method: "get", summary: "Get federated DM peer keys", tag: "Federation", security: "bearer" },
  { path: "/federation/dm/attachment", method: "get", summary: "Proxy federated DM attachment", tag: "Federation", security: "bearer" },
  ...
  { path: "/posts/{postID}/profile-pin", method: "put", summary: "Pin post to profile", tag: "Posts", security: "bearer" },
  { path: "/posts/{postID}/profile-pin", method: "delete", summary: "Unpin post from profile", tag: "Posts", security: "bearer" },
  ...
  { path: "/federation/posts/{incomingID}/reactions", method: "post", summary: "Add federated reaction", tag: "Federation", security: "bearer" },
  { path: "/federation/posts/{incomingID}/reactions/{emoji}", method: "delete", summary: "Remove federated reaction", tag: "Federation", security: "bearer" },
  ...
  { path: "/fanclub/patreon/authorize", method: "get", summary: "Start Patreon authorization", tag: "Fan club", security: "bearer" },
  { path: "/fanclub/patreon/status", method: "get", summary: "Get Patreon connection status", tag: "Fan club", security: "bearer" },
  { path: "/fanclub/patreon/connection", method: "delete", summary: "Delete Patreon connection", tag: "Fan club", security: "bearer" },
  { path: "/fanclub/patreon/entitlement", method: "post", summary: "Check Patreon entitlement", tag: "Fan club", security: "bearer" },
  { path: "/fanclub/patreon/entitlement-federated", method: "post", summary: "Check federated Patreon entitlement", tag: "Fan club", security: "bearer" },
  { path: "/fanclub/patreon/campaigns", method: "get", summary: "List Patreon campaigns", tag: "Fan club", security: "bearer" },
];
