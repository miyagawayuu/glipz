...
# Optional: federation/media tuning
...
VITE_ALLOWED_MEDIA_BASE_URLS=
VITE_ALLOWED_DM_ATTACHMENT_BASE_URLS=

# Optional: registration / email verification
...
SMTP_PASSWORD=
SMTP_TLS=auto
MAIL_FROM_EMAIL=no-reply@${DOMAIN}
MAIL_FROM_NAME=Glipz

# Optional: Patreon fan club
PATREON_ENABLED=false
PATREON_CLIENT_ID=
PATREON_CLIENT_SECRET=
PATREON_REDIRECT_URI=${public_origin}/api/v1/fanclub/patreon/callback

# Optional: Web Push
WEB_PUSH_VAPID_PUBLIC_KEY=
WEB_PUSH_VAPID_PRIVATE_KEY=
WEB_PUSH_VAPID_SUBJECT=mailto:no-reply@${DOMAIN}
EOF
}
